               ...
               <div class="row">
                  <div class="col-md-4 col-sm-12 left-rs">
                     <div class="navbar-header">
                        ...
                        <a href="homepage" class="navbar-brand"><img src="images/logo.png" alt="" /></a>
                     </div>
               ...
               <div class="row">
                  <div class="col-lg-8 col-lg-offset-2">
                     <div class="wow fadeIn" data-wow-delay="0.0s">
                        ...
                        <p class="lead">Here at Chamb, we want you to find new connections, grow profitable relationships, and make more money than you could ever dream of making. Sound like something youâd like to do? Then what are you reading this for?
                           <br>
                           <br>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-8 col-lg-offset-2">
                     ...
                     <p>Chamb hails from the Bosporus strait straddling Istanbul. Taking cues from this continent and culture spanning city, we bring people and place together in new and unexpected ways. Chamb may have its roots firmly planted in Turkey, but gaze out across fertile lands of Europe and youâll see its branches spreading a canopy of connection and possibility across the globe.</p>
                  </div>
                  ...
                  <div class="col-lg-8 col-lg-offset-2">
                     ...
                     <p>Over the coming years, the way that business through the web works will change at a great level - and Chamb is the gamebreaker. Customers will expect options of where and how to buy: in-store or online, delivered or for pick-up. Itâs an incredibly exciting time for this industry, and weâre going to be right at the centre of it.</p>
                     ...
                     <div class="row">
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                           <div class="rectange">
                              ...
                              <p class="rectange_text">Weâre growing, and weâre looking for talented people who can make commerce better.</p>
